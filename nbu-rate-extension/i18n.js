...
const FLAG_CODES = {
  ...
  RON: 'ro', ILS: 'il', KRW: 'kr', SGD: 'sg', HKD: 'hk',
  NZD: 'nz', MXN: 'mx', INR: 'in', XAU: 'gold'
};
...
function flagHtml(cc, width = 48) {
  ...
  const src = cc === 'XAU' ? 'flags/gold.png' : `flags/${code}.png`;
  return `<img class="flag" src="${src}" width="${width}" height="${height}" alt="${cc}" draggable="false" />`;
}
...
const TRANSLATIONS = {
  uk: {
    ...
    INR: 'Індійська рупія', XAU: 'Золото (тройська унція)'
  },
  en: {
    ...
    INR: 'Indian Rupee', XAU: 'Gold (troy ounce)'
  }
};
